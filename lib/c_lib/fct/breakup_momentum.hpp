#ifndef MESON_DECA__LIB__C_LIB__FCT__BREAKUP_MOMENTUM_HPP
#define MESON_DECA__LIB__C_LIB__FCT__BREAKUP_MOMENTUM_HPP
...
namespace fct {
  ...
  namespace breakup_momentum {
    ...
    complex_p(const T0& m2_R, const T1& m_a, const T2& m_b) {
      ...
      T_res p2 = fct::breakup_momentum::p2(m2_R, m_a, m_b);
    ...
    r2(const T0& m2_N, const T1& m2_D, const T2& m_a, const T3& m_b) {
      ...
      T_r1 p2_N = fct::breakup_momentum::p2(m2_N, m_a, m_b);
      T_r2 p2_D = fct::breakup_momentum::p2(m2_D, m_a, m_b);
