...
namespace fct {
  ...
  bool valid(const T0 &m2_ab, const T0 &m2_bc, 
             const T1 &m2_p, const T2 &m2_a, const T2 &m2_b, const T2 &m2_c)
  {
    ...
    typedef typename boost::math::tools::promote_args<T0,T1,T2,double>::type T_res;
		...
		const particle &b, const particle &c, const particle &d)
  {
    ...
    if (fct::valid(m2_123, m2_34, P.m2, m2_12, c.m2, d.m2) == false) {
      return false;
    }

    // 3 body decay R_1 -> a b c
    if (fct::valid(m2_12, m2_23, m2_123, a.m2, b.m2, c.m2) == false) {
      return false;
    }
